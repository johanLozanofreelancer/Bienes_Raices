    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <div >
            <picture>
                ...
                <img src="build/img/destacada.jpg" alt="imagen de propiedad destacada">
            </picture>
